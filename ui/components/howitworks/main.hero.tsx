...
import RightHero from "../hero/hero-right";
...
export default function MainHero() {
  return (
    ...
    >
      <div className="pt-[10rem] py-2 w-full mx-auto max-w-full lg:max-w-330 flex  flex-col gap-10 lg:flex-row  md:justify-between">
