  ...
  const faqs = [
    {
      ...
      questions: [
        ...
        {
          question: "Is paying someone to take my PMP test for me legal?",
          answer:
            "Yes, it is completely logical and legit if you take assistance in your PMP exam from third-party resources. At TestHelpNow, we place high value on privacy and confidentiality to make sure that the identity of our client is never revealed.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          question: "How is security and privacy maintained throughout the PMP exam?",
          answer:
    ...
    },
    {
      ...
      questions: [
        ...
        {
            question: "What occurs if the specialist fails the PMP exam",
            answer:"It is not possible that our PMP certified expert gat failed to provide 100% success results. However, you are entitled to a complete refund if the anticipated outcomes are not obtained due to any technical reasons. Our first priorities are your success and pleasure.",
