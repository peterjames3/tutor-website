      ...
      <div>
        <div>
          <h2 className="text-3xl sm:text-[2.5rem] lg:text-[3rem] xl:text-[3.1rem] font-bold mb-4 leading-tight">
            ...
            <span className="text-secondary">GED Exam </span>
          ...
          <p className="text-primary mb-4 text-lg leading-relaxed">
            TestHelpNow is a trusted platform to get with GED exam help for
            those who wants to earn GED certification. A team of professionals
            will take your GED exam on your behalf with guaranteed results. Get
