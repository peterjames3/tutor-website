  ...
  const faqs = [
    {
      ...
      questions: [
        ...
        {
          question: "Is paying someone to take my HiSET test for me legal?",
          answer:
            "Yes, it is completely logical and legit if you take assistance in your HiSET exam from third-party resources. At TestHelpNow, we place high value on privacy and confidentiality to make sure that the identity of our client is never revealed.",
        },
        {
          question: " Can I get urgent same-day HiSET help?",
          answer:
            "Yes! We offer urgent and same-day HiSET exam help. our expert team responds fast, assigns an expert quickly, and ensures smooth exam completion without delays or stress.",
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        {
          question: "What occurs if the specialist fails the HiSET exam",
          answer:
            "It is not possible that our HiSET certified expert get failed to provide 100% success results. However, you are entitled to a complete refund if the anticipated outcomes are not obtained due to any technical reasons. Our first priorities are your success and pleasure.",
        },
        {
