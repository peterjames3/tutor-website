...
export default async function RecentPosts() {
  ...
  return (
    <section className=" mt-2 space-y-8 grid grid-cols-2 md:grid-cols-3 gap-5 max-w-310 px-4 mx-auto ">
      {latestPosts.slice(1, 5).map((latestPost) => (
        ...
        >
          ...
          <footer className="flex text-secondary1-400 flex-row justify-between items-center">
